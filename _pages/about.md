...
Specializing in **Computational Science and Engineering (CSE)**, Ye's work bridges the disciplines of applied mathematics, computer science, and engineering to address intricate, real-world challenges. His research is particularly concentrated on **Computer-Aided Geometric Design (CAGD)** and **IsoGeometric Analysis (IGA)**, with a focus on advancing the theoretical underpinnings and developing efficient methodologies for **spline-based analysis-suitable parameterization**, **mesh generation**, and **geometric modelling**. This specialized area is a pivotal component of IGA that has significant ramifications for downstream simulation analysis. More recently, Ye also started focusing on fast and robust **structured mesh generation** for twin-screw machines, which are extensively employed in industries to produce high-pressure air and gases.
...
纪野是<a href="https://www.tudelft.nl/en/" target="_blank">代尔夫特理工大学（TU Delft）</a><a href="https://www.tudelft.nl/en/eemcs" target="_blank">电气工程、数学与计算机科学学院（EEMCS）</a><a href="https://www.tudelft.nl/ewi/over-de-faculteit/afdelingen/applied-mathematics" target="_blank">应用数学研究所（DIAM）</a><a href="https://www.tudelft.nl/ewi/over-de-faculteit/afdelingen/applied-mathematics/numerical-analysis" target="_blank">数值分析组</a>的博士后研究员。

他专注于**计算科学与工程（CSE）**，研究融合应用数学、计算机科学与工程学，致力于解决复杂的实际问题。研究重点是**计算机辅助几何设计（CAGD）**与**等几何分析（IGA）**，尤其关注**基于样条的分析适用参数化**、**网格生成**与**几何建模**的理论基础与高效算法——这是等几何分析中承上启下的关键环节，直接影响后续仿真分析的质量。近期，他还致力于双螺杆机械的快速、稳健**结构化网格生成**；此类机械被工业界广泛用于生产高压空气与气体。

科研之外，纪野担任美国数学会 *Mathematical Reviews* 的评论员，服务学术共同体。他也是开源等几何分析 C++ 软件平台 [Geometry + Simulation Modules (G+Smo)](https://gismo.github.io/) 的核心开发者之一。
...
- **[05/2026]**：我在意大利锡耶纳举行的 [**HOFEIM**](https://sites.google.com/unifi.it/hofeim2026/program) 2026 上展示了海报 [**Efficient Thermal Simulation in Metal Additive Manufacturing via Semi-Analytical Isogeometric Analysis**](https://www.sciencedirect.com/science/article/pii/S0045782526002653)。该工作提出了用于 LPBF 热仿真的半解析 IGA 框架，在复杂 CAD 几何上保持高精度的同时，相较传统有限元最高可提速 258 倍。

- **[04/2026]**：我有幸访问了蔚蓝海岸大学的 Inria 中心，与 AROMATH 团队成员就自适应等几何分析、样条技术与数值仿真展开交流。衷心感谢 Angelos Mantzaflaris 博士的盛情邀请，也感谢这次富有启发的讨论与令人振奋的研究氛围。

- **[01/2026]**：非常期待参加 2026 年 3 月 4-6 日在捷克皮尔森举行的 [**GiSmo developer days 2026**](https://github.com/gismo/gismo/wiki/GiSmo-Developer-days-2026)，期待与各位 GiSmo 开发者和用户见面！

- **[10/2025]**：很荣幸受大连理工大学数学科学学院邀请，作题为“面向等几何分析的分析适用参数化”的特邀报告。

- **[10/2025]**：很荣幸受 Stefanie Elgeti 教授邀请，访问其位于奥地利维也纳工业大学（TU Wien）轻量化与结构生物力学研究所的 Team Lightweight Design 课题组，十分期待此次访问！

- **[10/2025]**：我将在奥地利林茨举行的 [**Special Semester 2025 - Workshop 1 "Advances in Isogeometric Analysis"**](https://www.oeaw.ac.at/ricam/detail/event/special-semester-2025-workshop-1-advances-in-isogeometric-analysis) 上作口头报告。

- **[09/2025]**：我将在意大利雷焦卡拉布里亚举行的 [**SMART2025 - 4th International Conference on Subdivision, Geometric and Algebraic Methods, Isogeometric Analysis and Refinability in Italy**](https://smart2025.unirc.it/) 上作口头报告。

- **[09/2025]**：我将在荷兰埃因霍温举行的 [**IGA 2025 CONGRESS The Thirteenth International Conference on Isogeometric Analysis (IGA 2025)**](https://iga2025.cimne.com/) 上作口头报告。

- **[09/2025]**：我将在英国伦敦举行的 [**14th International Conference on Compressors and their Systems**](https://citycompressorsconference.london/) 上讲授一门短课程并作口头报告，期待分享我们在双螺杆机械结构化网格生成方面的最新进展。
...
- **[08/2025]**：我们的论文《The Regularity Determination of Spatial Coons Surface Patches and Its Applications》荣获 CSIAM GDC 2025 [**<font color=Red>会议最佳论文奖</font>**](../images/talks/2025-08-22-Yantai/GDC_Yantai_2.jpg)。感谢所有合作者！

- **[06/2025]**：我将在荷兰莱顿举行的 [**Generative AI in engineering design optimization**](https://www.lorentzcenter.nl/generative-ai-in-engineering-design-optimization.html) 研讨会上作口头报告。
...
- **[01/2025]**：我将于 2025 年 1 月 16 日在线上 [**GAMES Webinar 2024 – 357（CAD-CAE 集成及其应用）**](https://games-cn.org/games-webinar-20250116-357/) 作口头报告。

- **[01/2025]**：我将于 2025 年 1 月 7-10 日在意大利佛罗伦萨举行的 [**GiSmo Developer days and COSMIC meeting 2025**](https://github.com/gismo/gismo/wiki/GiSmo-Developer-days-and-COSMIC-meeting-2025) 作口头报告。
...
- **[06/2024]**：我将于 2024 年 6 月 3-7 日在葡萄牙里斯本举行的 [**第九届欧洲计算方法应用科学与工程大会（ECCOMAS CONGRESS 2024）**](https://eccomas2024.org/) 作口头报告。

- **[03/2024]**：我将于 2024 年 3 月 4-6 日在希腊塞萨洛尼基举行的 [**GiSmo developer days 2024**](https://github.com/gismo/gismo/wiki/GiSmo-developer-days-2024) 作口头报告。
...
- **[11/2023]**：我于 2023 年 11 月 21 日在辽宁大连成功通过博士学位论文答辩，论文题为《On domain parameterization for isogeometric analysis》。

- **[11/2023]**：我将于 2023 年 11 月 10 日在荷兰乌得勒支举行的 [**Dutch Computational Science Day**](https://ducomsday.nl/) 作海报展示。

- **[09/2023]**：我将于 2023 年 9 月 11-13 日在奥地利林茨举行的 [**RICAM Workshop on Topology Optimization and Isogeometric Analysis**](https://www.oeaw.ac.at/ricam/news-events/workshops/topology-optimization-and-isogeometric-analysis) 作口头报告。

- **[09/2023]**：我将于 2023 年 9 月 11 日在英国伦敦举行的 [**13th International Conference on Compressors and their Systems**](https://citycompressorsconference.london) 作口头报告。

- **[07/2023]**：非常高兴 [我们的论文](https://www.sciencedirect.com/science/article/abs/pii/S0167839623000237) 荣获 2023 年 7 月 5-7 日在意大利热那亚举行的 **International Conference on Geometric Modeling and Processing (GMP 2023)** **<font color=Red>会议最佳论文奖</font>**。

- **[06/2023]**：我将于 2023 年 6 月 18-21 日在法国里昂举行的 **11th International Conference on IsoGeometric Analysis (IGA 2023)** 作口头报告。

- **[05/2023]**：我将在线上 **中国图学学会“奋发图强”2023 博士生论坛** 作口头报告。
...
- **[02/2023]**：我们团队在 [**SIAM Hackathon 2023**](https://www.siam.org/conferences/cm/conference/cse23) 中荣获亚马逊云科技（AWS）挑战赛冠军。每位队员获得价值 250 欧元的 SIAM 图书代金券。[获奖证书](../images/talks/2023-02-26-siam-hackaton/SIAM_certificate.pdf)、[照片1](../images/talks/2023-02-26-siam-hackaton/SIAM_Hackathon2023_pic1.jpeg)、[照片2](../images/talks/2023-02-26-siam-hackaton/SIAM_Hackathon2023_pic2.jpeg)。

- **[01/2023]**：[一篇论文](https://www.global-sci.org/jcm/)被 [**Journal of Computational Mathematics**](https://www.global-sci.org/jcm/) 接收。
